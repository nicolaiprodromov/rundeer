...
from rundeer.core.paths import benchmark_dir, logs_dir
...
def compute_color_score(
    ...
    de = deltaE_ciede2000(lab_p, lab_t)
...
def run_position_benchmark(
    *,
    ...
    out_root = benchmark_dir(project_root, "position", "outputs", run_id)
    log_dir = logs_dir(project_root, "benchmark", "position")
